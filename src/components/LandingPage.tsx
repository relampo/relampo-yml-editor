        ...
        <main className="mx-auto max-w-7xl px-4 md:px-6">
            ...
            <div className="grid gap-12 md:grid-cols-2 md:items-center">
              <div>
                ...
                >
                  {language === 'en' ? (
                    <>
                      Record real traffic. Write <strong className="text-white">readable Scripts</strong>. Run in the{' '}
                      <strong className="text-white">cloud for free</strong>. No local limitations.
                    </>
                  ) : (
                    <>
                      Graba tráfico real. Escribe <strong className="text-white">Scripts legibles</strong>. Ejecuta en
                      la <strong className="text-white">nube gratis</strong>. Sin limitaciones locales.
                    </>
                  )}
                </m.p>
              ...
              >
                ...
                <div className="font-mono text-sm leading-relaxed">
                  ...
                  <m.div
                    ...
                    transition={{ duration: 0.5 }}
                  >
                    <span className="text-emerald-400">$</span> relampo run scenario.yaml --var env=staging --var
          ...
          >
            ...
            <div className="relative mb-16 px-4 md:px-12">
              {/* Background Line */}
              <div
                className="absolute left-0 right-0 top-8 h-0.5 bg-white/10"
                    ...
                    >
                      ...
                      <m.button
                        ...
                        className={`relative z-10 flex h-12 w-12 items-center justify-center rounded-full border-2 transition-all ${
                          isActive || isPast ? 'border-[#facc15] bg-[#facc15]' : 'border-white/20 bg-[#0a0a0a]'
                        }`}
                        animate={{
            ...
            <div className="rounded-3xl border border-[#facc15]/30 bg-gradient-to-br from-[#facc15]/10 via-transparent to-transparent p-8 md:p-12">
              <div className="grid gap-12 md:grid-cols-2 md:items-center">
                <div>
                  ...
                  <p className="text-lg text-zinc-300 mb-8">
                    ...
                    <strong className="text-white">{t.readableScripts.review}</strong>,{' '}
                    {language === 'en' ? 'and' : 'y'}{' '}
                  ...
                  <div className="space-y-3 mb-8">
                    ...
                    <div className="flex items-start gap-3 text-zinc-300">
                      ...
                      <div>
                        <div className="font-semibold text-white">
                          {t.readableScripts.features.versionControlFriendly.title}
                        </div>
                        <div className="text-sm text-zinc-400">
                          {t.readableScripts.features.versionControlFriendly.desc}
                        </div>
                      </div>
                    </div>
                    <div className="flex items-start gap-3 text-zinc-300">
                    ...
                    <div className="flex items-start gap-3 text-zinc-300">
                      ...
                      <div>
                        <div className="font-semibold text-white">
                          {t.readableScripts.features.strictValidation.title}
                        </div>
                  ...
                  <div className="rounded-xl border border-white/10 bg-white/5 p-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div className="text-sm text-zinc-300">
                        <strong className="text-white">{t.readableScripts.whyYamlTitle}</strong>{' '}
                        {t.readableScripts.whyYamlDesc}{' '}
                        <strong className="text-white">{t.readableScripts.strictValidationText}</strong>{' '}
                        {t.readableScripts.catchesErrors}
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="grid gap-4">
                  <div className="rounded-2xl border border-emerald-500/30 bg-emerald-950/20 p-6">
                    ...
                    <div className="overflow-x-auto text-sm leading-relaxed font-mono">
                      <m.div
                        animate={{
                          color: activeYamlLine === 0 ? '#facc15' : '#e4e4e7',
                        }}
                        transition={{ duration: 0.5 }}
                      >
                        scenarios:
                      ...
                      <m.div
                        animate={{
                          color: activeYamlLine === 1 ? '#facc15' : '#e4e4e7',
                        }}
                        transition={{ duration: 0.5 }}
                      >
                      ...
                      <m.div
                        animate={{
                          color: activeYamlLine === 2 ? '#facc15' : '#e4e4e7',
                        }}
                        transition={{ duration: 0.5 }}
                      >
                        &nbsp;&nbsp;&nbsp;&nbsp;load:
                      ...
                      <m.div
                        animate={{
                          color: activeYamlLine === 3 ? '#facc15' : '#e4e4e7',
                        }}
                        transition={{ duration: 0.5 }}
                      >
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;users: 50
                      ...
                      <m.div
                        animate={{
                          color: activeYamlLine === 4 ? '#facc15' : '#e4e4e7',
                        }}
                        transition={{ duration: 0.5 }}
                      >
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;duration: 2m
                      ...
                      <m.div
                        animate={{
                          color: activeYamlLine === 5 ? '#facc15' : '#e4e4e7',
                        }}
                        transition={{ duration: 0.5 }}
                      >
                        &nbsp;&nbsp;&nbsp;&nbsp;steps:
                      ...
                      <m.div
                        animate={{
                          color: activeYamlLine === 6 ? '#facc15' : '#e4e4e7',
                        }}
                        transition={{ duration: 0.5 }}
                      >
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;- request:
                      ...
                      <m.div
                        animate={{
                          color: activeYamlLine === 7 ? '#facc15' : '#e4e4e7',
                        }}
                        transition={{ duration: 0.5 }}
                      >
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;method: POST
                      ...
                      <m.div
                        animate={{
                          color: activeYamlLine === 8 ? '#facc15' : '#e4e4e7',
                        }}
                        transition={{ duration: 0.5 }}
                      >
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;url: /login
                      ...
                      <m.div
                        animate={{
                          color: activeYamlLine === 9 ? '#facc15' : '#e4e4e7',
                        }}
                        transition={{ duration: 0.5 }}
                      >
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;body:
                      ...
                      <m.div
                        animate={{
                          color: activeYamlLine === 10 ? '#facc15' : '#e4e4e7',
                        }}
                        transition={{ duration: 0.5 }}
                      >
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;username: test
                      ...
                      <m.div
                        animate={{
                          color: activeYamlLine === 11 ? '#facc15' : '#e4e4e7',
                        }}
                        transition={{ duration: 0.5 }}
                      >
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;password: secret
                      ...
                      <m.div
                        animate={{
                          color: activeYamlLine === 12 ? '#facc15' : '#e4e4e7',
                        }}
                        transition={{ duration: 0.5 }}
                      >
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;extract:
                      ...
                      <m.div
                        animate={{
                          color: activeYamlLine === 13 ? '#facc15' : '#e4e4e7',
                        }}
                        transition={{ duration: 0.5 }}
                      >
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;token: $.token
                      ...
                      <m.div
                        animate={{
                          color: activeYamlLine === 14 ? '#facc15' : '#e4e4e7',
                        }}
                        transition={{ duration: 0.5 }}
                      >
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;assert:
                      ...
                      <m.div
                        animate={{
                          color: activeYamlLine === 15 ? '#facc15' : '#e4e4e7',
                        }}
                        transition={{ duration: 0.5 }}
                      >
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;status: 200
                      ...
                      <m.div
                        animate={{
                          color: activeYamlLine === 16 ? '#facc15' : '#e4e4e7',
                        }}
                        transition={{ duration: 0.5 }}
                      >
                        &nbsp;
                      ...
                      <m.div
                        animate={{
                          color: activeYamlLine === 17 ? '#facc15' : '#e4e4e7',
                        }}
                        transition={{ duration: 0.5 }}
                      >
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;- think_time: 1s
                      ...
                      <m.div
                        animate={{
                          color: activeYamlLine === 18 ? '#facc15' : '#e4e4e7',
                        }}
                        transition={{ duration: 0.5 }}
                      >
                        &nbsp;
                      ...
                      <m.div
                        animate={{
                          color: activeYamlLine === 19 ? '#facc15' : '#e4e4e7',
                        }}
                        transition={{ duration: 0.5 }}
                      >
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;- POST: /api/orders
                      ...
                      <m.div
                        animate={{
                          color: activeYamlLine === 20 ? '#facc15' : '#e4e4e7',
                        }}
                        transition={{ duration: 0.5 }}
                      >
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;body:
                      ...
                      <m.div
                        animate={{
                          color: activeYamlLine === 21 ? '#facc15' : '#e4e4e7',
                        }}
                        transition={{ duration: 0.5 }}
                      >
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;product: "item-123"
                      ...
                      <m.div
                        animate={{
                          color: activeYamlLine === 22 ? '#facc15' : '#e4e4e7',
                        }}
                        transition={{ duration: 0.5 }}
                      >
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;quantity: 2
              ...
              <div className="mt-8 rounded-2xl border border-white/10 bg-[#0b0d14] p-6 text-center">
                <p className="text-lg text-zinc-300">
                  No compilation. No complex syntax. Just <strong className="text-white">clear test scripts</strong>{' '}
                  that work.
                </p>
              </div>
            </div>
            ...
            <div className="rounded-3xl border border-[#facc15]/30 bg-gradient-to-br from-[#facc15]/10 via-transparent to-transparent p-8 md:p-12">
              <div className="grid gap-12 md:grid-cols-2 md:items-center">
                <div>
                  ...
                  <p className="text-lg text-zinc-300 mb-8">
                    {t.freeCloud.description} <strong className="text-white">{t.freeCloud.concurrentVUs}</strong>{' '}
                    {t.freeCloud.and} <strong className="text-white">{t.freeCloud.hoursPerMonth}</strong>{' '}
                    {t.freeCloud.loadGeneration} {t.freeCloud.zeroSetup}
                  </p>
                ...
                <div className="grid grid-cols-2 gap-4">
                  {[
                    {
                      label: t.freeCloud.specs.virtualUsers,
                      value: '500',
                      unit: t.freeCloud.specs.concurrent,
                    },
                    {
                      label: t.freeCloud.specs.monthlyBudget,
                      value: '33',
                      unit: t.freeCloud.specs.hours,
                    },
                    {
                      label: t.freeCloud.specs.cpu,
                      value: 'AMD EPYC',
                      unit: t.freeCloud.specs.class,
                    },
                    {
                      label: t.freeCloud.specs.memory,
                      value: '8 GB',
                      unit: t.freeCloud.specs.perNode,
                    },
                    {
                      label: t.freeCloud.specs.nodes,
                      value: '4',
                      unit: t.freeCloud.specs.generators,
                    },
                    {
                      label: t.freeCloud.specs.architecture,
                      value: 'x86_64',
                      unit: 'Linux',
                    },
                  ].map(spec => (
                    <div
                      key={spec.label}
                      className="rounded-2xl border border-white/10 bg-[#0b0d14] p-5"
                    >
...
✓ Test running with staging overrides applied`}
          ...
          >
            <div className="text-center mb-12">
              ...
              <h2 className="text-4xl font-bold tracking-tight md:text-5xl mb-4">{t.roadmap.title}</h2>
              <p className="text-lg text-zinc-400 max-w-2xl mx-auto">{t.roadmap.cliSubtitle}</p>
            </div>
          ...
          >
            <div className="rounded-3xl border border-[#facc15]/30 bg-gradient-to-br from-[#facc15]/10 via-transparent to-transparent p-8 md:p-12 relative overflow-hidden">
              ...
              <div className="text-center mb-8">
                ...
                <p className="text-lg text-zinc-400 max-w-2xl mx-auto">{t.league.leagueDescription}</p>
              </div>
              ...
              <div className="max-w-3xl mx-auto mb-8 p-5 bg-[#111111] border border-white/10 rounded-xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-[11px] text-zinc-500 leading-relaxed">{t.league.howItWorks.bugHuntersDesc}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="max-w-4xl mx-auto">
                <div className="rounded-2xl border border-white/10 bg-[#0b0d14] overflow-hidden">
                  ...
                  <div className="divide-y divide-white/5">
                    {(leagueTimeRange === 'monthly' ? mockLeagueDataMonthly : mockLeagueDataAllTime)
                      .slice(0, 10)
                      .map(entry => {
                            ...
                            <div className="flex items-center gap-4">
                              ...
                              <div className="flex-shrink-0 w-12 text-center">
                                {isTopThree ? (
                                  ...
                                  <div className="text-sm font-bold text-zinc-500">#{entry.rank}</div>
                                )}
                              </div>
                  ...
                  <div className="px-6 py-6 border-t border-white/10 bg-[#07080c] text-center">
                    <p className="text-sm text-zinc-400 mb-4">{t.league.joinLeague}</p>
                    <button
                      disabled
                    ...
                    <div className="flex items-center gap-3">
                      <div className="text-center px-3 py-2 bg-[#111111] border border-white/10 rounded-lg">
                        ...
                        <div className="text-base font-bold text-[#facc15]">
                          <span className="text-zinc-600 line-through mr-1 text-xs">500</span>
                          750
                        </div>
                      </div>
                      <div className="text-center px-3 py-2 bg-[#111111] border border-white/10 rounded-lg">
            ...
            <div className="text-center mb-12">
              ...
              <h2 className="text-4xl font-bold tracking-tight md:text-5xl mb-4">
                {language === 'en'
                  ...
                  : 'Construido por ingenieros de software que entienden las pruebas'}
              </h2>
                ...
                >
                  <div className="flex items-start gap-4 mb-4">
                    ...
                    <div>
                      ...
                      <div className="text-xs font-semibold uppercase tracking-wider text-[#facc15]">{m.role}</div>
                    </div>
                  </div>
          ...
          >
            <div className="rounded-3xl border border-[#facc15]/30 bg-gradient-to-br from-[#facc15]/10 via-transparent to-transparent p-12 text-center">
              ...
              <p className="text-lg text-zinc-300 max-w-2xl mx-auto mb-8">{t.finalCta.description}</p>
