    ...
    <div className="max-w-7xl mx-auto px-8 py-12">
      ...
      <div className="mt-16 p-6 bg-neutral-50 border-2 border-neutral-200 rounded-xl">
        ...
        <div className="space-y-1 text-sm text-neutral-600">
          <p>
            <strong className="text-yellow-600">Gradiente oficial:</strong> #fde047 → #facc15 → #eab308
          </p>
          <p>
            <strong className="text-yellow-600">Path del rayo (oficial del Sidebar):</strong> M10.5 0L0 12.5H7.5L6 22L18
            9H10.5V0Z
          </p>
          <p>
            <strong className="text-yellow-600">ViewBox del rayo:</strong> 0 0 18 22
          </p>
          <p>
            <strong className="text-yellow-600">Fuente:</strong> System UI (sans-serif), font-weight: 900
          </p>
          <p>
            <strong className="text-yellow-600">Letter spacing:</strong> 0.18em para "RELAMPO"
          </p>
          <p>
            <strong className="text-yellow-600">Formato:</strong> Todos los logos se descargan en SVG (vector escalable)
          </p>
        </div>
      </div>
    </div>
