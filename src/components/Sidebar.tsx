...
export function Sidebar({ activeNav, onNavigate }: SidebarProps) {
  ...
  const navItems = [
    ...
    {
      id: 'workbench' as NavigationItem,
      label: t('sidebar.workbench'),
      icon: FlaskConical,
    },
    { id: 'cli' as NavigationItem, label: 'CLI', icon: Terminal },
    {
      id: 'projects' as NavigationItem,
      label: t('sidebar.projects'),
      icon: FolderKanban,
    },
    {
      id: 'brand-campaign' as NavigationItem,
    ...
    {
      id: 'design-doc' as NavigationItem,
      label: t('sidebar.designDoc'),
      icon: FileText,
    },
  ];
    ...
    <aside className="w-56 bg-[#0a0a0a] border-r border-white/5 flex flex-col shadow-2xl">
      <div className="p-4 border-b border-white/5">
        ...
        >
          ...
          <span className="text-xl font-black text-zinc-100 group-hover:text-yellow-400 tracking-tight transition-colors">
            RELAMPO
          </span>
        </a>
      </div>
