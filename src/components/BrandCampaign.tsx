...
`;
  ...
  const handleDownloadAll = async () => {
    ...
    try {
      ...
      zip.file(
        'README.md',
        `# Relampo Brand Campaign Package
    ...
    <div className="h-full w-full bg-[#0a0a0a] flex flex-col overflow-hidden">
      ...
      <div className="bg-[#111111] border-b border-white/5 px-8 py-4 flex-shrink-0">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold text-zinc-100 tracking-tight">Relampo Brand Campaign</h1>
              <p className="text-sm text-zinc-400 mt-0.5">Event Materials • Swag • Print-Ready Assets</p>
            </div>
          </div>
      ...
      <div className="flex flex-1 overflow-hidden min-h-0">
        ...
        <div className="w-64 border-r border-white/5 bg-[#0a0a0a] overflow-y-auto flex-shrink-0">
          <div className="p-4">
            <h3 className="text-xs font-semibold text-zinc-500 uppercase tracking-wider mb-3">Materials</h3>
            ...
            {/* Brand Colors */}
            <div className="mt-8">
              <h3 className="text-xs font-semibold text-zinc-500 uppercase tracking-wider mb-3">Brand Colors</h3>
      ...
      <div className="max-w-2xl mx-auto">
        ...
        >
          <div className="absolute inset-0 flex flex-col items-center justify-center p-12 text-center">
            ...
            {/* Brand Name */}
            <h1 className="text-7xl font-black text-zinc-100 tracking-tighter mb-6">RELAMPO</h1>
        ...
        <div className="mt-6 flex justify-center">
          <Button
            ...
            onClick={() => onDownload('Roll-up Banner', 'rollup')}
          >
            <Download className="w-4 h-4 mr-2" />
      ...
      <div className="mt-12">
        ...
        <div className="grid grid-cols-3 gap-4">
          {[
            ...
            <div
              key={i}
              className="bg-[#111111] border border-white/5 rounded-lg p-4 text-center hover:border-yellow-400/30 transition-colors cursor-pointer"
            >
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="mt-8">
        ...
        <div className="space-y-2">
          {designs.map((design, i) => (
            <div
              key={i}
              className="bg-[#111111] border border-white/5 rounded-lg p-4 flex items-center justify-between hover:border-yellow-400/30 transition-colors"
            >
      ...
      <div className="mt-8 flex justify-center">
        <Button
          className="bg-yellow-400 text-black hover:bg-yellow-300"
          onClick={() => onDownload('T-Shirts', 'tshirt')}
        >
          <Download className="w-4 h-4 mr-2" />
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="mt-8 flex justify-center">
        <Button
          className="bg-yellow-400 text-black hover:bg-yellow-300"
          onClick={() => onDownload('Hoodie Designs', 'hoodie')}
        >
          <Download className="w-4 h-4 mr-2" />
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="mt-8 flex justify-center">
        <Button
          className="bg-yellow-400 text-black hover:bg-yellow-300"
          onClick={() => onDownload('Sticker Pack', 'stickers')}
        >
          <Download className="w-4 h-4 mr-2" />
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="mt-8 flex justify-center">
        <Button
          className="bg-yellow-400 text-black hover:bg-yellow-300"
          onClick={() => onDownload('Coasters', 'coasters')}
        >
          <Download className="w-4 h-4 mr-2" />
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="max-w-md mx-auto">
        <div
          className="bg-[#111111] border border-white/5 rounded-2xl p-12 flex items-center justify-center"
          style={{ height: '500px' }}
        >
        ...
        <div className="mt-6 flex justify-center">
          <Button
            className="bg-yellow-400 text-black hover:bg-yellow-300"
            onClick={() => onDownload('Water Bottles', 'bottle')}
          >
            <Download className="w-4 h-4 mr-2" />
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="mt-8 flex justify-center">
        <Button
          className="bg-yellow-400 text-black hover:bg-yellow-300"
          onClick={() => onDownload('Tote Bags', 'totebag')}
        >
          <Download className="w-4 h-4 mr-2" />
        ...
        <div className="bg-[#0a0a0a] border border-yellow-400/30 rounded-xl p-12 aspect-[183/76]">
          <div className="h-full flex items-center justify-between px-12">
            ...
            <div className="text-center flex-1 px-12">
              <h1 className="text-6xl font-black text-zinc-100 tracking-tighter mb-4">RELAMPO</h1>
              <p className="text-2xl font-semibold text-yellow-400 mb-6">Performance testing made simple.</p>
  ...
  return (
    <div className="space-y-8">
            ...
            <div className="h-full flex flex-col justify-between text-sm text-zinc-400">
              <div>
                ...
                <p className="text-sm leading-relaxed mb-4">
                  A modern performance testing tool that turns real HTTP traffic into trustworthy, declarative load
                  tests.
                </p>
              </div>
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <div className="w-16 h-16 bg-white rounded-lg flex items-center justify-center">
                    <div className="text-[8px] text-center text-zinc-800 font-bold">
                      QR
                      <br />
                      CODE
                    </div>
      ...
      <div className="mt-8 flex justify-center">
        <Button
          className="bg-yellow-400 text-black hover:bg-yellow-300"
          onClick={() => onDownload('Info Cards', 'cards')}
        >
          <Download className="w-4 h-4 mr-2" />
          Download Info Cards
        </Button>
