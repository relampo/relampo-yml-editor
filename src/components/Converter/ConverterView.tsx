...
export function ConverterView() {
  ...
  const performSearch = (query: string, direction: 'next' | 'previous' = 'next') => {
    ...
    editorRef.current.trigger(
      'source',
      direction === 'next' ? 'editor.action.nextMatchFindAction' : 'editor.action.previousMatchFindAction',
    );
  };
      ...
      <header>
        ...
        <div className="lang-toggle">
          <span
            ...
            style={{ color: lang === 'en' ? '#facc15' : '#a3a3a3' }}
          >
            EN
          </span>
          <label
          ...
          <span
            className="lang-label"
            style={{ color: lang === 'es' ? '#facc15' : '#a3a3a3' }}
          >
            ES
          </span>
        </div>
      ...
      <div className="main-layout">
        ...
        >
            ...
            <div className="search-bar">
              <div className="search-input-container">
                ...
                <span className="search-counter">
                  {searchMatches.current}/{searchMatches.count}
                </span>
              </div>
              <div className="search-buttons">
                <button
                  className="btn-icon"
                  onClick={() => performSearch(searchValue, 'previous')}
                  disabled={searchMatches.count === 0}
                  title="Previous"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <button
                  className="btn-icon"
                  onClick={() => performSearch(searchValue, 'next')}
                  disabled={searchMatches.count === 0}
                  title="Next"
                >
                  <svg
          ...
          <div
            ...
            style={{ flex: 1, padding: 0, overflow: 'hidden', border: 0 }}
          >
            <Editor
              height="100%"
