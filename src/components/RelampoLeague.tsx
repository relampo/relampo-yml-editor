...
interface RelampoLeagueProps {
  onViewFull?: () => void;
}

export function RelampoLeague({ onViewFull }: RelampoLeagueProps) {
  ...
  return (
    <div className="bg-[#111111] rounded-xl border border-white/5 shadow-2xl overflow-hidden">
      ...
      <button
        onClick={onViewFull}
        className="w-full px-6 py-3 flex items-center justify-center gap-2 text-sm font-medium text-yellow-400 hover:bg-yellow-500/10 transition-colors border-t border-white/5"
      >
