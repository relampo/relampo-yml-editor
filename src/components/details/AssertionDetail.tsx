      ...
      <div className="px-6 py-4 border-b border-white/5">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-zinc-400 mt-1">Validate response data and ensure expected behavior</p>
          </div>
            ...
            <div>
              ...
              <div
                className={`px-3 py-2 border rounded-lg text-sm font-mono ${
                  data.passed ? 'bg-green-50 border-green-200 text-green-900' : 'bg-red-50 border-red-200 text-red-900'
                }`}
              >
                {data.actual}
              </div>
          ...
          {data.passed !== undefined && (
            <div
              className={`p-4 rounded-lg ${
                data.passed ? 'bg-green-50 border border-green-200' : 'bg-red-50 border border-red-200'
              }`}
            >
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <p className={`text-sm ${data.passed ? 'text-green-900' : 'text-red-900'}`}>
                    {data.passed
