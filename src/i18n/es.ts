  ...
  yamlEditor: {
    ...
    balanced: {
      ...
      alerts: {
        ...
        issueInvalidPartialTotal: 'El porcentaje total asignado no puede superar el 100. Total actual: {total}%.',
        issueThinkTimeChild:
          'think_time no puede ser hijo de un balanced controller — consume un porcentaje de carga sin emitir ningún request.',
    ...
    intent: {
      ...
      sections: {
        ...
        slo: {
          title: 'Límites SLO',
          description:
            'Estos valores se muestran como referencia y se generan automáticamente según el perfil intent seleccionado.',
        },
      },
      fields: {
      ...
      runtime: {
        title: 'Línea de tiempo del runtime de intent',
        subtitleRps: 'El RPS se mantiene cerca del objetivo mientras Relampo ajusta los VUs según los SLO.',
        subtitleVus: 'VUs reales ajustados por el controlador durante esta ejecución.',
        target: 'Objetivo',
        time: 'Tiempo',
        state: 'Estado',
        vus: 'VUs',
        ...
        bestRps: 'Mejor RPS',
        bestVus: 'Mejores VUs',
        response: 'Respuesta {metric}',
        violations: 'Incumplimientos',
        yes: 'Sí',
        no: 'No',
        thresholdP95: 'p95 <= {value}',
        thresholdErrors: 'errores <= {value}%',
        states: {
          warmup: 'Warmup',
          rampup: 'RampUp',
          probing: 'Sondeo',
        ...
        verdicts: {
          ...
          bestFeasible: 'Mejor opción viable',
          sustained: 'Objetivo sostenido',
          notSustained: 'Objetivo no sostenido',
          partiallySustained: 'Parcialmente sostenido',
          inconclusive: 'No concluyente',
        },
        resultTitle: 'Resultado de intent',
      },
    },
